...
Component({
  ...
  properties: {
    ...
    // 限制：最多17个选项， 单个选项最多填15个字, 选项名称最多10个字
    ...
    */
    ...
    _zhuan() {
      ...
      setTimeout(function () {
        ...
        //要转多少度deg
        app.runDegs = app.runDegs || 0, app.runDegs = 360 + (2160 - r * (360 / awardsConfig.awards.length));
      ...
      timer = setTimeout(function () {
        ...
        that.setData({
          animationData: {},
          s_awards: awardsConfig.awards[r].name || awardsConfig.awards[r].coursename,//最终选中的结果
          awardsConfig: awardsConfig,
          block1: 'none',
          block2: 'none',
          block3: 'block',
